...
export default abstract class BodyPart {
  ...
  public reset() {
    this.bone.position.set(
      this.originalPositionEuler.x,
      this.originalPositionEuler.y,
      this.originalPositionEuler.z,
    );
    this.bone.rotation.set(
      this.originalRotationEuler.x,
      this.originalRotationEuler.y,
      this.originalRotationEuler.z,
    );
  }
