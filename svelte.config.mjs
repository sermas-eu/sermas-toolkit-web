...
export const toolkitAliases = {
    ...
    "@sermas/toolkit/events": "../sermas-toolkit-web/src/events/index.ts",
    "@sermas/toolkit/dto": "../sermas-toolkit-web/src/dto/index.ts",
    "@sermas/toolkit/ui": "../sermas-toolkit-web/src/ui/index.ts",
    "@sermas/toolkit/avatar": "../sermas-toolkit-web/src/avatar/index.ts",
    "@sermas/toolkit/settings/*": "../sermas-toolkit-web/src/settings/*",
    "@sermas/toolkit/ui/*": "../sermas-toolkit-web/src/ui/*",
    // // '@sermas/toolkit': '../sermas-toolkit-web/src/index.ts',
